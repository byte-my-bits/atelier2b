...
class Company():
    def __init__(self, name, type, address, current_user, id="" ):
        ...
        self.membersArchitects = []
        self.membersStructure = []
        self.membersMepDesign = []
        ...
        print(f"![Debug]! membersArchitects: {self.membersArchitects}")
        print(f"![Debug]! membersStructure: {self.membersStructure}")
        print(f"![Debug]! membersMepDesign: {self.membersMepDesign}")
    ...
    def make_fromdict(cls,d):
        ...
        return cls(d['name'], d['type'], d['membersArchitects'], d['membersStructure'], d['membersMepDesign'], d['address'], d['id'])
    ...
    def dict(self):
        ...
        return {
            ...
            "name": self.name,
            "type": self.type,
            "membersArchitects": self.membersArchitects,
            "membersStructure": self.membersStructure,
            "membersMepDesign": self.membersMepDesign,
            "owner": self.owner,
